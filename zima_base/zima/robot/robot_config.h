...
const std::string Chassis::kLeftCliffSensor_ = "left cliff sensor";
const std::string Chassis::kLeftFrontCliffSensor_ = "left front cliff sensor";
const std::string Chassis::kRightFrontCliffSensor_ = "right front cliff sensor";
const std::string Chassis::kRightCliffSensor_ = "right cliff sensor";
