...
class AutoCleaningMode : public OperationMode {
  public:
    ...
    AutoCleaningMode(const Chassis::SPtr &chassis, const ChassisController::SPtr &chassis_controller, const SlamBase::SPtr &slam_wrapper,
                     const EntranceType &entrance_type = kTotallyNewCleaning, const AutoCleaning::AutoCleaningInfo::SPtr &cached_cleaning_info = nullptr,
  ...
  private:
    ...
    // Initializing state
    bool InitializeForTotallyNewCleaning(const OperationData::SPtr &operation_data);
    bool InitializeForNewCleaningBaseOnSelectedNavData(const OperationData::SPtr &operation_data);
    bool InitializeForResumeCleaningWithRobotQuiescentState(const OperationData::SPtr &operation_data);
    bool InitializeForResumeCleaningWithRobotActiveState(const OperationData::SPtr &operation_data);
