...
PauseMode::PauseMode(const Chassis::SPtr &chassis, const ChassisController::SPtr &chassis_controller, const SlamBase::SPtr &slam_wrapper)
    : ModeBase("Pause mode", chassis, chassis_controller), start_request_(false), slam_wrapper_(slam_wrapper) {
