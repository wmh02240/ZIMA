...
class AutoScanHouseModeWrapper : public ModeEventWrapperBase {
  public:
    AutoScanHouseModeWrapper(const Chassis::SPtr &chassis, const ChassisController::SPtr &chassis_controller, const SlamBase::SPtr &slam_wrapper,
                             OperationData::SPtr &operation_data, const AutoScanHouse::AutoScanningInfo::SPtr &cached_scanning_info = nullptr,
