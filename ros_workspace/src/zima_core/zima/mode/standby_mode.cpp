...
StandbyMode::StandbyMode(const Chassis::SPtr &chassis, const ChassisController::SPtr &chassis_controller, const SlamBase::SPtr &slam_wrapper)
    : ModeBase("Standby mode", chassis, chassis_controller), start_request_(false), slam_wrapper_(slam_wrapper) {
