...
class OperationDataSerializer {
  public:
    ...
    static ZimaProto::OperationData::POperationData ToProto(const OperationData::SPtr &data);
    static bool FromProto(OperationData::SPtr &data, const ZimaProto::OperationData::POperationData &proto);
};

class OperationDataLoader : public NavDataLoader {
  public:
    OperationDataLoader() = default;
    explicit OperationDataLoader(const std::string &file_dir, const std::string &file_name) : NavDataLoader(file_dir, file_name){};
    ~OperationDataLoader() = default;
...
class OperationDataWriter : public NavDataWriter {
  public:
    ...
    explicit OperationDataWriter(const std::string &file_dir, const std::string &file_name) : NavDataWriter(file_dir, file_name){};
    ~OperationDataWriter() = default;
