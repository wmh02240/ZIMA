...
class RoomInfo {
  public:
    ...
    RoomInfo(const CharGridMap2D::DataType &room_index, const DynamicMapCellBound room_bound, const MapCell &section_base_cell,
...
class NavData {
  public:
    ...
    class VirtualWall {
      public:
        VirtualWall() = delete;
        VirtualWall(const MapPoint &point1, const MapPoint &point2, const bool &enable = true, const UserBlockType &type = UserBlockType::kStrictBlock);
    ...
    class BlockArea {
      public:
        BlockArea() = delete;
        BlockArea(const MapPoint &point1, const MapPoint &point2, const MapPoint &point3, const MapPoint &point4, const bool &enable = true,
    ...
    void UpdateProbabilityIndexGridMap2D(const ProbabilityIndexGridMap2D::SPtr &value);
    ...
    bool UpdateVirtualWall(const uint8_t &index, const VirtualWall::SPtr &virtual_wall);
    bool RemoveVirtualWall(const uint8_t &index);
    bool GetVirtualWall(const uint8_t &index, VirtualWall::SPtr &virtual_wall) const;
    ...
    void UpdateUserSelectAreaInNavMap(const CharGridMap2D::SPtr &new_user_select_area_map);
...
class NavDataSerializer {
  public:
    ...
    static bool FromProto(RoomInfo::SPtr &room_info, const ZimaProto::NavData::PRoomInfo &proto);

    static ZimaProto::NavData::PVirtualWall ToProto(const NavData::VirtualWall::SPtr &virtual_wall);
    static bool FromProto(NavData::VirtualWall::SPtr &virtual_wall, const ZimaProto::NavData::PVirtualWall &proto);

    static ZimaProto::NavData::PBlockArea ToProto(const NavData::BlockArea::SPtr &block_area);
    static bool FromProto(NavData::BlockArea::SPtr &block_area, const ZimaProto::NavData::PBlockArea &proto);

    static ZimaProto::NavData::PNavData ToProto(const NavData::SPtr &data);
    static bool FromProto(NavData::SPtr &data, const ZimaProto::NavData::PNavData &proto);
};

class NavDataLoader : public LocalProtoFileReader {
  public:
    NavDataLoader() = default;
    explicit NavDataLoader(const std::string &file_dir, const std::string &file_name) : LocalProtoFileReader(file_dir, file_name){};
    ~NavDataLoader() = default;
...
class NavDataWriter : public LocalProtoFileWriter {
  public:
    ...
    explicit NavDataWriter(const std::string &file_dir, const std::string &file_name) : LocalProtoFileWriter(file_dir, file_name){};
    ~NavDataWriter() = default;
