...
class MapConverter : public DebugBase {
  public:
     ...
     */
    bool ConvertSlamValueGridMap2DToRoomMap(const SlamValueGridMap2D::SPtr &slam_map, CharGridMap2D::SPtr &room_map);
     ...
     * @return true for convertion finished.
     */
    bool ConvertSlamValueGridMap2DToCharSlamMap(const SlamValueGridMap2D::SPtr &slam_map, CharGridMap2D::SPtr &char_slam_map);
     ...
     * @return true for convertion finished.
     */
    bool ConvertProbabilityGridMap2DToSlamValueGridMap(const ProbabilityIndexGridMap2D::SPtr &probability_map, SlamValueGridMap2D::SPtr &slam_map);
};
...
class SlamMapUtil : public DebugBase {
  public:
    ...
    static bool IsVisiable(const SlamValueGridMap2D::DataType &value,
                           const SlamValueGridMap2D::DataType &min_value = SlamValueGridMap2D::GetPredefineDefaultValue() + 1,
                           const SlamValueGridMap2D::DataType &max_value = SlamValueGridMap2D::GetPredefineMediumValue()) {
        return value >= min_value && value <= max_value;
    }
    static bool IsObstacle(const SlamValueGridMap2D::DataType &value,
                           const SlamValueGridMap2D::DataType &min_value = SlamValueGridMap2D::GetPredefineMediumValue() + 1,
                           const SlamValueGridMap2D::DataType &max_value = SlamValueGridMap2D::GetPredefineMaxObstacleValue()) {
        return value >= min_value && value <= max_value;
    }
    static bool IsUnknown(const SlamValueGridMap2D::DataType &value,
                          const SlamValueGridMap2D::DataType &min_value = SlamValueGridMap2D::GetPredefineMediumValue() + 1,
                          const SlamValueGridMap2D::DataType &max_value = SlamValueGridMap2D::GetPredefineMediumValue() - 1) {
        return (value >= min_value && value <= max_value) || value == SlamValueGridMap2D::GetPredefineDefaultValue();
    }
};
...
class RoomMapUtil : public DebugBase {
  public:
     ...
     */
    bool CheckAndUpdateRoomMap(const SlamValueGridMap2D::SPtr &slam_map, CharGridMap2D::SPtr &room_map);
     ...
     */
    bool UpdateRoomsInfo(const CharGridMap2D::SPtr &room_map, RoomsInfo &rooms_info);
     ...
     */
    bool SplitRoom(CharGridMap2D::SPtr &room_map, const CharGridMap2D::DataType &target_room_value, const MapCells &split_line, RoomsInfo &rooms_info);
     ...
     */
    bool MergeRoom(CharGridMap2D::SPtr &room_map, const CharGridMap2D::DataType &merge_room_1, const CharGridMap2D::DataType &merge_room_2,
     ...
     * @return true for generation succeeded.
     */
    bool GenerateXYRangeForRoom(const CharGridMap2D::SPtr &room_map, const DynamicMapCellBound &room_bound, uint16_t &range_x, uint16_t &range_y);
};
...
class BicubicInterpolator : public DebugBase {
  public:
    ...
    static float BiCubicBaseFunctionCalculateWeight(const float &a, const float &input);
    static std::shared_ptr<float> Interpolate(const ProbabilityIndexGridMap2D::SPtr probability_index_grid_map, const MapPoint &interpolate_point,
                                              const float &a = -0.5);
    static FloatValueGridMap2D::SPtr Interpolate(const ProbabilityIndexGridMap2D::SPtr probability_index_grid_map, const float &scale, const float &a = -0.5);
};
