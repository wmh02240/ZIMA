...
class PoseInterpolatorBase {
  public:
    static MapPoint::SPtr CalculateVelocity(const MergedOdomData &a, const MergedOdomData &b);

    static MergedOdomData::SPtr PredictPose(const std::deque<MergedOdomData::SPtr> buffer, const double &timestamp);
    static bool IsInterpolatable(const std::deque<MergedOdomData::SPtr> buffer, const double &timestamp);
    static MergedOdomData::SPtr InterpolatePose(const std::deque<MergedOdomData::SPtr> buffer, const double &timestamp);
