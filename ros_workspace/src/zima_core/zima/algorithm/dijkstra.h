...
class DijkstraBase : public DebugBase {
  public:
     ...
     */
    using ExpendCondition = std::function<bool(MultiLayersCharGridMap2D::SPtr map, MapCell &curr_step, MapCell &next_step)>;
     ...
     */
    using FinishCondition = std::function<bool(MultiLayersCharGridMap2D::SPtr map, MapCell &curr_step)>;
     ...
     * @param  curr_step The cell for current step.
     */
    using CellStepCallback = std::function<void(MultiLayersCharGridMap2D::SPtr map, MapCell &curr_step)>;
     ...
     */
    using IterationStepCallback = std::function<void(MultiLayersCharGridMap2D::SPtr map, MapCells &new_iter_cells)>;
     ...
     */
    bool Search(MultiLayersCharGridMap2D::SPtr map, const MapCells &start_cells, MapCell &target, const ExpendCondition &expend_cond,
                const FinishCondition &finish_cond, const CellStepCallback &cell_step_cb, const IterationStepCallback &iter_step_cb);
    /**
