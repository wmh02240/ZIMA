...
bool ReturnHomePlanner::GeneratePathToStartPoint(NavMap::SPtr map, const MapPoint &start_pose, const MapPoints &start_points, MapPointPath &output_path,
    ...
    if (GeneratePathToTarget(process_map, start_pose, start_point, output_path, output_cell_path, expend_cond)) {
        return true;
    }
