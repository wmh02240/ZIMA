...
void LineSegmentTest5() {
...

    {
        ...
        if (LineSegmentAlgorithm::PerpendicularPointOnLine(*line, test_input, perpendicular_point)) {
            ZINFO << "Perpendicular point of " << test_input.DebugString() << " is " << perpendicular_point.DebugString();
        } else {
