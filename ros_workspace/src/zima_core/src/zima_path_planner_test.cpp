...
void ZigZagTest() {
    ...
    while (planner_manager.GeneratePath(nav_map, section_nav_map, current_pose, bound, nav_map->GetRoomLayer()->GetDefaultValue(), path, cell_path, true)) {
        ...
        section_nav_map->MarkForCleaningSteps(*TransformManager::Instance(), _steps, bound);
