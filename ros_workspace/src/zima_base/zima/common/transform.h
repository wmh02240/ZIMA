...
class Transform {
  public:
    ...
    Transform(const std::string &target_frame, const std::string &source_frame)
        : access_(std::make_shared<ReadWriteLock>()), target_frame_(target_frame), source_frame_(source_frame), x_(0), y_(0), degree_(0) {}
    Transform(const std::string &target_frame, const std::string &source_frame, const double &x, const double &y, const double &degree)
        : access_(std::make_shared<ReadWriteLock>()), target_frame_(target_frame), source_frame_(source_frame), x_(x), y_(y), degree_(degree) {}
    ...
    static void CoordinateTransformationAB(const double &x_in_a, const double &y_in_a, const double &x_a_to_b, const double &y_a_to_b,
                                           const double &radian_a_to_b, double &x_in_b, double &y_in_b) {
    ...
    static void CoordinateTransformationBA(const double &x_in_b, const double &y_in_b, const double &x_a_to_b, const double &y_a_to_b,
                                           const double &radian_a_to_b, double &x_in_a, double &y_in_a) {
...
class TransformManager {
  ...
  public:
    ...
    bool UpdateTransform(const std::string &target_frame, const std::string &source_frame, const MapPoint &offset_in_source_frame);
    bool GetTransform(const std::string &target_frame, const std::string &source_frame, Transform &out) const;
